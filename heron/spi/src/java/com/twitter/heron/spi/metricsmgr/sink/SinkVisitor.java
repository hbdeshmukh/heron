...
public interface SinkVisitor extends AutoCloseable {
  ...
  /**
   * Retrieve a specific set of metrics from the next record
   *
   * @return A set of metrics and their corresponding values
   */
  Iterable<MetricsInfo> getNextMetrics(List<String> metrics);
